...
model = dict(
    ...
    backbone=dict(
        ...
        sa_channels=(((5, 5, 11), (11, 11, 22)), ((22, 22, 45), (22, 34, 45)),
                     ((45, 70, 91), (45, 70, 91)), ((91, 91, 182), (91, 137, 182))),
    ...
    neck=dict(
        ...
        #              (257, 128, 128))),
        fp_channels=((546, 182, 182), (272, 182, 182), (215, 91, 91),
                     (92, 45, 45))),
    rpn_head=dict(
        type='PointRPNHead',
        num_classes=3,
        ...
        pred_layer_cfg=dict(
            in_channels=45,
            cls_linear_channels=(91, 91),
            reg_linear_channels=(91, 91)),
        cls_loss=dict(
            type='FocalLoss',
            use_sigmoid=True,
            reduction='sum',
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            pred_layer_cfg=dict(
                in_channels=182,
                cls_conv_channels=(91, 91),
                reg_conv_channels=(91, 91),
                bias=True),
            in_channels=5,
            ...
            sa_channels=((45, 45, 45), (45, 45, 91), (91, 91, 182)),
